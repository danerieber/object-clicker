...
<div transition:fade style="display: flex; flex-direction: column">
    ...
    {#if decorators}
        <div style="display: flex; flex-direction: row">
            <input id={"coffeed" + o.type} type=checkbox checked={coffeed} on:click|preventDefault={toggleCoffeed}>
            <label for={"coffeed" + o.type}>Coffee Decorator</label>
        </div>
        <div style="display: flex; flex-direction: row">
            <input id={"leetcoded" + o.type} type=checkbox checked={leetcoded} on:click|preventDefault={toggleLeetcoded}>
